...
def test_display_help(set_a_test_env):
...
def test_search_and_submit_a_town_name(set_a_test_env):
...
def test_display_any_error_message(set_a_test_env):
    result = forms.display_any_error_message("complement_adresse")
    assert isinstance(result, bool)
    assert result is False


def test_submit_a_location_get_form(set_a_test_env):
...
def test_submit_a_company_get_form(set_a_test_env):
...
def test_submit_a_client_get_form(set_a_test_env):
...
def test_submit_a_collaborator_get_form(set_a_test_env):
...
def test_submit_a_collaborator_role_get_form(set_a_test_env):
...
def test_submit_a_collaborator_department_get_form(set_a_test_env):
...
def test_submit_a_contract_get_form(set_a_test_env):
...
def test_submit_a_event_get_form(set_a_test_env):
