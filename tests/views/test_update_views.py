...
def test_update_contract_view(get_runner, get_valid_decoded_token_for_a_commercial_collaborator):
    try:
...
def test_update_event_view(get_runner, get_valid_decoded_token_for_a_commercial_collaborator):
    try:
...
def test_update_location_view(get_runner, get_valid_decoded_token_for_a_commercial_collaborator):
    try:
...
def test_update_role_view(get_runner, get_valid_decoded_token_for_a_gestion_collaborator):
    try:
...
def test_update_department_view(get_runner, get_valid_decoded_token_for_a_gestion_collaborator):
    try:
