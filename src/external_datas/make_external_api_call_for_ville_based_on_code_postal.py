...
def get_town_name_from_insee_open_api(code_postal):
    ...
    fiels = 'nom,code,codesPostaux,siren,codeEpci,codeDepartement,codeRegion,population&format=json&geometry=centre'
    query_string = f"codePostal={digit_code_postal}&fields={fiels}"
    town_name = ""
    region_name = ""
    population = ""
