"""
On fournit une vue dédiée d'atteindre les modèles métier dans le cas d'une mise à jour.
"""
...
try:
    ...
    from src.controllers.database_update_controller import DatabaseUpdateController
    ...
    from controllers.database_update_controller import DatabaseUpdateController
