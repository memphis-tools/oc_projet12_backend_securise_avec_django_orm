...
class DeleteAppViews:
    """
    Description: une classe dédiée à servir les vues de l'application dans le cas d'une suppression.
    """

    def __init__(self, db_name=f"{settings.DATABASE_NAME}"):
        """
        Description: vue dédiée à instancier la base de données et retourner un controleur pour la suppression.
        """
