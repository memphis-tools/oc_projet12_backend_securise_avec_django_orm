...
def help():
    ...
    Exemples:
    oc12_clients client_id=FJONIC35[/cyan]
    oc12_events commercial_id=aa123456789[/cyan]
    oc12_update_contract --contract_id ff555 remain_amount_to_pay=99.99 et status=signed[/cyan]
    oc12_delete_contract --contract_id xx55555[/cyan]
    oc12_contracts --help[/cyan]
    """
    )
    return True
